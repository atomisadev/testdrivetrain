...
public class DriveSubsystem extends SubsystemBase{
    ...
    public DriveSubsystem()
     { 
        ...
        m_pose = new Pose2d(Robot.getNavX().getDisplacementX(), Robot.getNavX().getDisplacementY(), new Rotation2d(Robot.getNavX().getAngle()));
        
        output = DBSTab.add("PID Output", 0).withWidget(BuiltInWidgets.kNumberSlider).getEntry();
        setpoint = DBSTab.add("PID Setpoint", 0).withWidget(BuiltInWidgets.kNumberSlider).getEntry(); 
    ...
    public void periodic() {
        ...
        // left.getPosition(),
        // right.getPosition());
        m_pose = new Pose2d(Robot.getNavX().getDisplacementX(), Robot.getNavX().getDisplacementY(), gyroAngle);
    ...
    public void resetPose() {
        ...
        m_pose = new Pose2d(right.getPosition(), right.getPosition(), Robot.getNavX().getRotation2d());
        Robot.getNavX().resetDisplacement(); // should reset the displacement - some method i found in the docs
        Robot.getNavX().reset();
    }
